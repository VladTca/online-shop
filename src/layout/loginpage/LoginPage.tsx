            ...
            <S.Form>
                ...
                <S.FieldContainer>
                    ...
                    <S.InputBlock><Icon iconId={"user"} height={"20"} width={"20"} viewBox={"0 0 20 20"} stroke={theme.colors.Neutral100}/>
                        <S.Field type="text" placeholder="Enter username" required/>
                    </S.InputBlock>
                    <S.Label htmlFor="password">Password</S.Label>
                    <S.InputBlock>
                        <Icon iconId={"lock-close"} height={"20"} width={"20"} viewBox={"0 0 20 20"} stroke={theme.colors.Neutral100}/>
                        <S.Field type="password" placeholder="Enter password" required/>
                    </S.InputBlock>
                    <S.ForgotPassword>Forgot password?</S.ForgotPassword>
                    <Button btnType={'runningOrder'}><S.LinkTo to="/app">Running Order</S.LinkTo>
                    </Button>
                </S.FieldContainer>
